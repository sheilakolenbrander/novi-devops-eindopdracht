...
- Create Angular project with ng: `ng new novi-devops-eindopdracht.client --defaults --skip-install --skip-git `.
...
- Create project file (`novi-devops-eindopdracht.client.esproj`).
